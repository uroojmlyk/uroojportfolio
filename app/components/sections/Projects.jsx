...
export default function Projects() {
  const projects = [
    ...
    {
      id: 3,
      title: "Zeno Software House",
      role: "Full Stack Development - Next.js",
      description: "A professional software house website for Zeno software house based in karachi DHA 6. Features modern UI, services showcase, portfolio display, client testimonials, and complete business information with contact integration.",
      image: "/love.png",

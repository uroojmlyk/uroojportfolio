    ...
    <nav className={`fixed top-0 w-full z-50 transition-all duration-500 ${
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-20 lg:h-24">
          ...
          {/* ---------- LOGO - CLASSIC MODERN FONT + SPACED LETTERS ---------- */}
          <Link href="/" className="group relative">
            <div className="flex items-center gap-[2px] sm:gap-1">
              {['U', 'R', 'O', 'O', 'J'].map((letter, index) => (
                <span
                  key={index}
                  className="text-2xl lg:text-3xl font-light tracking-[-0.02em] text-[#333333] group-hover:text-[#FF8A5C] transition-all duration-300 hover:scale-110 inline-block"
                  style={{ 
              ...
              <span className="text-2xl lg:text-3xl font-bold text-[#FF8A5C] ml-0.5 animate-pulse-slow">.</span>
            </div>
            <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-[#FF8A5C] group-hover:w-full transition-all duration-300"></span>
          </Link>
